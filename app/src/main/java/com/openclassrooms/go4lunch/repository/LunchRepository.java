        ...
        .get().addOnCompleteListener(task -> {
            if (task.isSuccessful()) {
                ...
                if(task.getResult().size()!=0) {
                    Log.e("TAG_GET_TODAY_LUNCH", "getTodayLunch: "+ idw+" booked for Lunch this restaurant "+querySnapshot.toObjects(Lunch.class).get(0).getRestaurantChoosed().getName());
        ...
        getLunchCollection()
            ...
            if (task.isSuccessful()) {
                ...
                for (QueryDocumentSnapshot document : task.getResult()) {
                    workmates.add(document.toObject(Lunch.class).getWorkmates());
                    Log.e("Error", "documents "+document.toObject(Lunch.class).getWorkmates());
                }
                ...
                .addOnCompleteListener(task -> {
                    if(task.isSuccessful()){
                        for (QueryDocumentSnapshot document : task.getResult()) {
                            ...
                            Log.e("delete ", "lunch: "+ document.toObject(Lunch.class).getRestaurantChoosed().getName());
                        }
                    }
                    else {
